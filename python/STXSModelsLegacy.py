...
class StageOnePTwo(STXSBaseModel):
    ...
    def __init__(self):
        STXSBaseModel.__init__(self)  # not using 'super(x,self).__init__' since I don't understand it
        self.POIs = "mu"
        from HiggsAnalysis.CombinedLimit.STXSLegacy import stage1_2_procs, stage1_2_fine_procs, stage1_2_merged_procs
    ...
    def doParametersOfInterest(self):
        ...
        if self.addStage0:
            from HiggsAnalysis.CombinedLimit.STXSLegacy import stage0_procs
